#ifndef __ASM_C6X_FUTEX_IRQ_H
#define __ASM_C6X_FUTEX_IRQ_H
/*
 * This code is borrowed from SH implementation. Since C6x is UP only, basic
 * C implementation with irq clear/restore will work.
 */
