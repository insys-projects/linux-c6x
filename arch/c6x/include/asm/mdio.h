...
#define EMAC_M_CLKDIV            ((1 << 8) - 1)

#define EMAC_B_INTTESTENB        (1 << 17)
...
#define MDIO_MODE_LOOPBACK       0x0020 /* Use PHY Loopback          */
#define MDIO_MODE_NWAYACTIVE     0x0040 /* NWAY is currently active  */

/*
 * MDIO states in the PHY state machine
 */
#define MDIO_PHY_MDIOINIT        0
#define MDIO_PHY_NWAYSTART       1
#define MDIO_PHY_NWAYWAIT        2
#define MDIO_PHY_LINKWAIT        3
#define MDIO_PHY_LINKED          4
...
#define MDIO_PHY_B_MSG           (1<<0)     /* for ADVERTISE */
