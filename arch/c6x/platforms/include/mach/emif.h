...
#define EMIFA_STAT	__REG(EMIFA_BASE + 0x04)
#define EMIFA_BPRIO	__REG(EMIFA_BASE + 0x20)
#define EMIFA_CE2CFG	__REG(EMIFA_BASE + 0x80)
#define EMIFA_CE3CFG	__REG(EMIFA_BASE + 0x84)
#define EMIFA_CE4CFG	__REG(EMIFA_BASE + 0x88)
#define EMIFA_CE5CFG	__REG(EMIFA_BASE + 0x8C)
#define EMIFA_AWCC	__REG(EMIFA_BASE + 0xA0)
#define EMIFA_INTRAW	__REG(EMIFA_BASE + 0xC0)
#define EMIFA_INTMSK	__REG(EMIFA_BASE + 0xC4)
#define EMIFA_INTMSKSET	__REG(EMIFA_BASE + 0xC8)
#define EMIFA_INTMSKCLR	__REG(EMIFA_BASE + 0x0C)
